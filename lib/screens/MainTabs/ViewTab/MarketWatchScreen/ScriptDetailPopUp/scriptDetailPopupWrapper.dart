                                  ...
                                  Container(
                                    child: ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        return bottomSheetList((controller.selectedScriptForF5.value!.depth!.buy![index].price ?? 0).toString(), (controller.selectedScriptForF5.value!.depth!.buy![index].orders ?? 0).toString(), (controller.selectedScriptForF5.value!.depth!.buy![index].quantity ?? 0).toString(), AppColors().blueColor, 0);
                                      },
                                    ),
                                  ),
                                  Container(
                                ...
                                children: [
                                  ...
                                  Container(
                                    child: ListView.builder(
                                      ...
                                      padding: EdgeInsets.zero,
                                      itemBuilder: (context, index) {
                                        return bottomSheetList((controller.selectedScriptForF5.value!.depth!.sell![index].price ?? 0).toString(), (controller.selectedScriptForF5.value!.depth!.sell![index].orders ?? 0).toString(), (controller.selectedScriptForF5.value!.depth!.sell![index].quantity ?? 0).toString(), AppColors().redColor, 0);
                                      },
                                    ),
                                  ),
                                  Container(
