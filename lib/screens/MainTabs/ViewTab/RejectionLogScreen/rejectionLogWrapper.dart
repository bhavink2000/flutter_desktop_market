...
class RejectionLogScreen extends BaseView<RejectionLogController> {
  ...
  Widget vBuilder(BuildContext context) {
    return FocusTraversalGroup(
      ...
      child: Visibility(
        visible: Get.find<MainContainerController>().selectedCurrentTab == "Rejection Log",
  ...
  Widget mainContent(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: AnimatedContainer(
        duration: Duration(milliseconds: 100),
        width: controller.isFilterOpen ? 1460 : 1840,
          ...
          child: Row(
            ...
            children: [
              valueBox(shortFullDateTime(logValue.createdAt!), 33, index % 2 == 0 ? Colors.transparent : AppColors().grayBg,
                  ...
                  isBig: true),
              valueBox(logValue.status ?? "", 33, index % 2 == 0 ? Colors.transparent : AppColors().grayBg, AppColors().darkText,
                  index,
                  isBig: true),
              valueBox(logValue.userName ?? "", 45, index % 2 == 0 ? Colors.transparent : AppColors().grayBg,
                  AppColors().darkText, index,
                  isUnderlined: true),
              ...
              //     isBig: true),
              valueBox(logValue.ipAddress ?? "", 45, index % 2 == 0 ? Colors.transparent : AppColors().grayBg,
                  AppColors().darkText, index),
              valueBox(logValue.deviceId ?? "", 45, index % 2 == 0 ? Colors.transparent : AppColors().grayBg,
                  AppColors().darkText, index,
                  isBig: true),
            ],
          ),
  ...
  Widget listTitleContent() {
    return Row(
      ...
      children: [
        // titleBox("", 0),
        titleBox("Date", isBig: true),
        titleBox("Rejection Reason", isBig: true),
        titleBox("Username"),
        titleBox("Sumbol", isBig: true),
        titleBox("Type"),
        titleBox("Quanity"),
        titleBox("Price"),
