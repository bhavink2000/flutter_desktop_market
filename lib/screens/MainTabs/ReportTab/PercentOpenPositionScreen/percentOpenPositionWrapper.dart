      ...
      child: Container(
        child: Row(
          ...
          children: [
            ...
            valueBox("MCX GOLD Oct 05", 45, index % 2 == 0 ? Colors.transparent : AppColors().grayBg, AppColors().redColor, index,
                isBig: true),
            valueBox("24.00", 45, index % 2 == 0 ? Colors.transparent : AppColors().grayBg, AppColors().darkText, index,
                isBig: true),
            valueBox("0.00", 45, index % 2 == 0 ? Colors.transparent : AppColors().grayBg, AppColors().darkText, index),
            valueBox("58906.00", 45, index % 2 == 0 ? Colors.transparent : AppColors().grayBg, AppColors().darkText, index,
                isBig: true),
            valueBox("10.00", 45, index % 2 == 0 ? Colors.transparent : AppColors().grayBg, AppColors().darkText, index,
                isBig: true),
            valueBox("0.00", 45, index % 2 == 0 ? Colors.transparent : AppColors().grayBg, AppColors().darkText, index),
            valueBox("58906.00", 45, index % 2 == 0 ? Colors.transparent : AppColors().grayBg, AppColors().darkText, index,
                isBig: true),
            ...
            valueBox("0.00", 45, index % 2 == 0 ? Colors.transparent : AppColors().grayBg, AppColors().darkText, index),
            valueBox("-463,300.00", 45, index % 2 == 0 ? Colors.transparent : AppColors().grayBg, AppColors().redColor, index,
                isBig: true),
            valueBox("0.00", 45, index % 2 == 0 ? Colors.transparent : AppColors().grayBg, AppColors().blueColor, index,
                isBig: true),
          ],
        ),
      ),
