...
class TradeAccountScreen extends BaseView<TradeAccountController> {
  ...
  Widget vBuilder(BuildContext context) {
    return FocusTraversalGroup(
      ...
      child: Visibility(
        visible: Get.find<MainContainerController>().selectedCurrentTab == "Trade Account",
        child: Column(
          children: [
            Expanded(
              child: Row(
      ...
      child: Container(
        child: Row(
          ...
          children: [
            ...
            valueBox("58 906.00", 45, index % 2 == 0 ? Colors.transparent : AppColors().grayBg, AppColors().redColor, index,
                isBig: false),
            valueBox("58 906.00", 45, index % 2 == 0 ? Colors.transparent : AppColors().grayBg, AppColors().darkText, index,
                isBig: false),
            valueBox("58 906.00", 60, index % 2 == 0 ? Colors.transparent : AppColors().grayBg, AppColors().blueColor, index,
                isBig: false),
            valueBox("58 906.00", 45, index % 2 == 0 ? Colors.transparent : AppColors().grayBg, AppColors().redColor, index,
                isBig: false),
            valueBox("58 906.00", 45, index % 2 == 0 ? Colors.transparent : AppColors().grayBg, AppColors().darkText, index,
