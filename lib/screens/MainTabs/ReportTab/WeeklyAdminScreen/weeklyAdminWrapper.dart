...
class WeeklyAdminScreen extends BaseView<WeeklyAdminController> {
  ...
  Widget vBuilder(BuildContext context) {
    return FocusTraversalGroup(
      ...
      child: Visibility(
        visible: Get.find<MainContainerController>().selectedCurrentTab == "Weekly Admin",
        child: Column(
          children: [
            Expanded(
              child: Row(
        ...
        child: Container(
          child: Row(
            ...
            children: [
              ...
              valueBox(adminValue.adminProfit.toStringAsFixed(2), 45, index % 2 == 0 ? Colors.transparent : AppColors().grayBg, controller.getColor(adminValue.adminProfit.toDouble()), index),
