...
class ManageTradeScreen extends BaseView<ManageTradeController> {
  ...
  Widget vBuilder(BuildContext context) {
    return FocusTraversalGroup(
      ...
      child: Visibility(
        visible: Get.find<MainContainerController>().selectedCurrentTab == "Manage Trades",
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            exchangeTypeDropDown(controller.selectedExchange, onChange: () async {
                              await getScriptList(
                                  exchangeId: controller.selectedExchange.value.exchangeId!,
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            allScriptListDropDown(controller.selectedScriptFromFilter,
                                arrSymbol: controller.arrExchangeWiseScript, width: 200),
                            SizedBox(
                              width: 30,
                            ),
                          ],
      ...
      return GestureDetector(
        ...
        child: Container(
          decoration: BoxDecoration(
              color: Colors.transparent,
              border: Border.all(
                  width: 1, color: controller.selectedOrderIndex == index ? AppColors().darkText : Colors.transparent)),
          child: Row(
            mainAxisAlignment: MainAxisAlignment.start,
            children: [
              valueBox(controller.arrTrade[index].userName ?? "", 45, index % 2 == 0 ? Colors.transparent : AppColors().grayBg,
              ...
              valueBox(
                  controller.arrTrade[index].executionDateTime == null
                      ? ""
                  ...
                  index,
                  isForDate: true),
              valueBox(controller.arrTrade[index].symbolName ?? "", 45, index % 2 == 0 ? Colors.transparent : AppColors().grayBg,
                  controller.arrTrade[index].tradeType == "buy" ? AppColors().blueColor : AppColors().redColor, index,
                  isLarge: true),
              valueBox(
                  ...
                  index),
              valueBox(controller.arrTrade[index].quantity.toString(), 45,
                  index % 2 == 0 ? Colors.transparent : AppColors().grayBg, AppColors().darkText, index),
              valueBox(controller.arrTrade[index].price.toString(), 45, index % 2 == 0 ? Colors.transparent : AppColors().grayBg,
                  controller.arrTrade[index].tradeType == "buy" ? AppColors().blueColor : AppColors().redColor, index),
              valueBox(
              ...
              valueBox(
                  ...
                  index),
              valueBox(controller.arrTrade[index].exchangeName ?? "0", 60,
                  index % 2 == 0 ? Colors.transparent : AppColors().grayBg, AppColors().darkText, index),
              // valueBox(shortFullDateTime(controller.arrTrade[index].createdAt!), 45,
              //     index % 2 == 0 ? Colors.transparent : AppColors().grayBg, AppColors().darkText, index,
              //     isBig: true),
              valueBox(controller.arrTrade[index].ipAddress ?? "", 45, index % 2 == 0 ? Colors.transparent : AppColors().grayBg,
                  AppColors().darkText, index),
              valueBox(controller.arrTrade[index].orderMethod ?? "", 45, index % 2 == 0 ? Colors.transparent : AppColors().grayBg,
                  AppColors().darkText, index),
              valueBox(controller.arrTrade[index].deviceId ?? "", 45, index % 2 == 0 ? Colors.transparent : AppColors().grayBg,
                  AppColors().darkText, index),
            ],
          ),
        ),
