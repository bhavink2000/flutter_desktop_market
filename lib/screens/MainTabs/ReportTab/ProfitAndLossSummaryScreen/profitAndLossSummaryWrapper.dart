...
class ProfitAndLossSummaryScreen extends BaseView<ProfitAndLossSummaryController> {
  ...
  Widget vBuilder(BuildContext context) {
    return FocusTraversalGroup(
      ...
      child: Visibility(
        visible: Get.find<MainContainerController>().selectedCurrentTab == "P&L Summary",
        child: Column(
          children: [
            Expanded(
              child: Row(
            ...
            Container(
              ...
              child: Center(
                ...
                children: [
                  ...
                  totalContent(
                      value: controller.getTotal("pl").toStringAsFixed(2),
                      textColor: controller.getTotal("pl") >= 0 ? AppColors().blueColor : AppColors().redColor,
                      width: 150),
                  totalContent(
                      value: controller.getTotal("brk").toStringAsFixed(2),
                      textColor: controller.getTotal("brk") >= 0 ? AppColors().blueColor : AppColors().redColor,
                      width: 110),
                  totalContent(
                      value: controller.getTotal("Total").toStringAsFixed(2),
                      textColor: controller.getTotal("Total") >= 0 ? AppColors().blueColor : AppColors().redColor,
                      width: 110),
                  totalContent(
                      value: controller.getTotal("m2m").toStringAsFixed(2),
                      textColor: controller.getTotal("m2m") >= 0 ? AppColors().blueColor : AppColors().redColor,
                      width: 110),
                  totalContent(
                      value: controller.getTotal("netPL").toStringAsFixed(2),
                      textColor: controller.getTotal("netPL") >= 0 ? AppColors().blueColor : AppColors().redColor,
                      width: 110),
                ],
              )),
            ),
    ...
    return GestureDetector(
      ...
      child: Container(
        child: Row(
          ...
          children: [
            valueBox(scriptValue.symbolTitle ?? "", 30, index % 2 == 0 ? Colors.transparent : AppColors().grayBg,
                AppColors().darkText, index,
                isLarge: true, onClickValue: () {
              showProfitAndLossSummaryPopUp();
            }),
            valueBox(scriptValue.profitLoss!.toStringAsFixed(2), 45, index % 2 == 0 ? Colors.transparent : AppColors().grayBg,
                scriptValue.profitLoss! >= 0 ? AppColors().blueColor : AppColors().redColor, index,
                isBig: true),
            ...
            valueBox(
                scriptValue.total.toStringAsFixed(2),
                45,
                index % 2 == 0 ? Colors.transparent : AppColors().grayBg,
                (scriptValue.profitLoss! - scriptValue.brokerageTotal!) >= 0 ? AppColors().blueColor : AppColors().redColor,
                index),
            valueBox(
                scriptValue.totalProfitLossValue.toStringAsFixed(2),
                45,
                index % 2 == 0 ? Colors.transparent : AppColors().grayBg,
                scriptValue.totalProfitLossValue >= 0 ? AppColors().blueColor : AppColors().redColor,
                index),
            valueBox(scriptValue.netPL.toStringAsFixed(2), 45, index % 2 == 0 ? Colors.transparent : AppColors().grayBg,
                scriptValue.netPL >= 0 ? AppColors().blueColor : AppColors().redColor, index),
          ],
        ),
      ),
    );
