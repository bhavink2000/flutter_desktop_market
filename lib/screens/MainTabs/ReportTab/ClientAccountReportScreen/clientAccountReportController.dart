    ...
    if (socketData.status == true) {
      ...
      if (obj != null) {
        ...
        if (indexOfScript != -1) {
          ...
          arrSummaryList[indexOfScript].currentPriceFromSocket = arrSummaryList[indexOfScript].profitLossValue = arrSummaryList[indexOfScript].totalQuantity! < 0 ? socketData.data!.ask!.toDouble() : socketData.data!.bid!.toDouble();
          if (indexOfScript == 0) {}
