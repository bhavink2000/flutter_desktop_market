...
class MessagesScreen extends BaseView<MessagesController> {
  ...
  Widget vBuilder(BuildContext context) {
    return FocusTraversalGroup(
      ...
      child: Visibility(
        visible: Get.find<MainContainerController>().selectedCurrentTab == "Messages",
      ...
      return GestureDetector(
        ...
        child: Container(
          child: Row(
            ...
            children: [
              valueBox(
                  index.toString(), 33, index % 2 == 0 ? Colors.transparent : AppColors().grayBg, AppColors().darkText, index,
                  isSmall: true),
              valueBox(notificationValue.message ?? "", 33, index % 2 == 0 ? Colors.transparent : AppColors().grayBg,
                  AppColors().darkText, index,
                  isExtraLarge: true),
              valueBox(shortFullDateTime(notificationValue.createdAt!), 45,
